...
namespace RabbitRollSCPSL.InfiniteAmmo
{
    public class PluginMain : Plugin<Config>
    {
        ...
        public override void OnEnabled()
        {
            ...
            Log.Warn("RabbitRollSCPSL.InfiniteAmmo is enabled!");
        ...
        private void RegisterEvents()
        {
            ...
            Exiled.Events.Handlers.Item.ChangingAmmo += _eventWeaponHandler.OnChangingAmmo;
            Exiled.Events.Handlers.Player.DroppingAmmo += _eventWeaponHandler.OnDroppingAmmo;
            Exiled.Events.Handlers.Player.Shot += _eventWeaponHandler.OnShot;
            Exiled.Events.Handlers.Player.ChangedItem += _eventWeaponHandler.OnChangedItem;
            Exiled.Events.Handlers.Player.DroppingItem += _eventWeaponHandler.OnDroppingItem;
            Exiled.Events.Handlers.Player.ChangingItem += _eventWeaponHandler.OnChangingItem;
        }
